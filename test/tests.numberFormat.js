...
describe('FEUtils.numberFormat 的测试用例', function() {
  it(`FEUtils.numberFormat({number: 1234567}) should return true`, function () {
    assert.equal(FEUtils.numberFormat({number: 1234567}), '1,234,567')
  });
  it(`FEUtils.numberFormat({number: '-123456'}) should return true`, function () {
    assert.equal(FEUtils.numberFormat({number: '-123456'}), '-123,456')
  });
  it(`FEUtils.numberFormat({number: '-0'}) should return true`, function () {
