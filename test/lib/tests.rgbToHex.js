...
describe('feutils.rgbToHex 的测试用例', function() {
  ...
  it(`feutils.rgbToHex('rgb(256,110,110,0.59)') should return error`, function () {
    try {
      feutils.rgbToHex('rgb(256,110,110,0.59)')
    } catch(e) {
      assert(true);
    }
  });
  it(`feutils.rgbToHex('rg(195,110,110,0.59)') should return error`, function () {
    try {
      feutils.rgbToHex('rg(195,110,110,0.59)')
    } catch(e) {
      assert(true);
    }
  });
